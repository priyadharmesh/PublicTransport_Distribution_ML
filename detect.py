...
URl='https://api.thingspeak.com/update?api_key=' #OXIYKQKX9SN3K3KF&field1=0&field2=0&field=0&field4=0'
KEY='K7M0XWDR2CQE09FL'  # Thingspeak channel to update 3HEXXTITMR9I5I9   JRAI9MM3TER6F8P
# ----------------------------------------------------------------------
def send_IoTData(field1,field2,field3,field4):   
    try:
        params = urllib.urlencode({'field1': field1, 'field2': field2,'key':key })
        headers = {"Content-typZZe": "application/x-www-form-urlencoded","Accept": "text/plain"}
        conn = http.client.HTTPSConnection("api.thingspeak.com:80")
